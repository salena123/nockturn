          ...
          <tbody>
            {filteredTeachers.map((teacher) => (
              <tr key={teacher.id}>
                ...
                <td style={{ border: '1px solid #ddd', padding: '12px' }}>
                  {teacher.user?.hire_date ? 
                    new Date(teacher.user.hire_date).toLocaleDateString('ru-RU') : '—'
                  }
                </td>
                          ...
                          <tr key={index}>
                            ...
                            <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                              <span style={{
                                ...
                                borderRadius: '3px',
                                fontSize: '11px',
                                backgroundColor: lesson.type === 'lesson' ? '#d4edda' : 
                                                 lesson.type === 'event' ? '#d1ecf1' : '#fff3cd',
                                color: lesson.type === 'lesson' ? '#155724' : 
                                       lesson.type === 'event' ? '#0c5460' : '#856404'
                              }}>
                                {lesson.type === 'lesson' ? 'Урок' : 
                                 lesson.type === 'event' ? 'Мероприятие' : 'Мастер-класс'}
                              </span>
                            </td>
                          </tr>
                        ))}
